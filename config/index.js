export class Config {
  ...
  constructor() {
    this.#exchange = { 
      ...
      pair: process.env.TRADING_PAIR || 'BTC/USDT:USDT', 
    ...
    this.#indicators = { 
      emaFast: parseInt(process.env.EMA_FAST, 10) || 50, 
      emaSlow: parseInt(process.env.EMA_SLOW, 10) || 200, 
      ...
      macdFast: parseInt(process.env.MACD_FAST, 10) || 12, 
    ...
    this.#timeframes = { 
      primary: process.env.TIMEFRAME_PRIMARY || '15m', 
      secondary: process.env.TIMEFRAME_SECONDARY || '1h', 
      tertiary: process.env.TIMEFRAME_TERTIARY || '4h' 
    };
    ...
    this.#logging = { 
      ...
      maxSizeMB: parseInt(process.env.LOG_MAX_SIZE_MB, 10) || 50, 
